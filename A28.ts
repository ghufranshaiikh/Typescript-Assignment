...
function toddlerage(age:number){
    if(age>=2&&age<4){
...
function teenagerage(age:number){
    if(age>=13&&age<20){
       return "the person is a teenager";  
    }   else{  return "the person is not a teenager";
    } 
}
...
function adultage(age:number){
    ...
    }   else{  return "the person is not an adult";
    } 
}
